...
class InvertWidget (
    ...
    override val title: Int = R.string.image_tracing_invert_option
    override val icon: ImageVector = Icons.Default.InvertColors
    override val helpMessage: Int = R.string.image_tracing_invert_help
