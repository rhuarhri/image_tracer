...
class MonochromeWidget(
    ...
    override val title: Int = R.string.image_tracing_monochrome_option
    override val icon: ImageVector = Icons.Default.Contrast
    override val helpMessage: Int = R.string.image_tracing_monochrome_help
